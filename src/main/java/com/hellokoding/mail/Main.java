...
public class Main {
    public static void main(String[] args) {
        ...
        sendingMailThroughGmailSMTPServer.sendMail(fromUserEmail, fromUserAccessToken, toUserEmail, "Sending Email Through Gmail SMTP Server with Java Mail API and OAuth 2 Authorization", "Hi Giau,\n\rThis is a programmatic email.");
    }
}
